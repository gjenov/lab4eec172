...
//(int x, int y, unsigned char c,unsigned int color, unsigned int bg, unsigned char size)
void printAllFonts(){
    ...
    x = 0;
        ...
        for(i = 0; i < 16; i++){
            drawChar(x, y, *font + (j*16 + i), WHITE, BLACK, fontSize);
            x += 8;
            delay(1);
        }
    y += 8;
...
void drawHorizontalLines(){
    ...
    delay(10);
    drawLine(0,16,127,16, BLUE);
    delay(10);
    drawLine(0,32,127,32, GREEN);
    delay(10);
    drawLine(0,48,127,48, CYAN);
    delay(10);
    drawLine(0,64,127,64, RED);
    delay(10);
    drawLine(0,80,127,80, MAGENTA);
    delay(10);
    drawLine(0,96,127,96, YELLOW);
    delay(10);
    drawLine(0,112,127,112, CYAN + 4);
    delay(10);
}
//void drawLine(int x0, int y0, int x1, int y1, unsigned int color) {
void drawVerticalLines(){
    fillScreen(BLACK);
    drawLine(0,127,0,0, WHITE);
    delay(10);
    drawLine(16,127,16,0, BLUE);
    delay(10);
    drawLine(32,127,32,0, GREEN);
    delay(10);
    drawLine(48,127,48,0, CYAN);
    delay(10);
    drawLine(64,127,64,0, RED);
    delay(10);
    drawLine(80,127,80,0, MAGENTA);
    delay(10);
    drawLine(96,127,96,0, YELLOW);
    delay(10);
    drawLine(112,127,112,0, CYAN + 4);
    delay(10);
}
